...
<!--Start Intro-->               
Cursando Análise e Desenvolvimento de Sistemas. Gosto de tecnologia e programação, com experiência em Python, visão computacional, Deep Learning e automações. Já desenvolvi projetos nessas áreas, além de trabalhar em projetos com JavaScript e desenvolvimento web. Também curto explorar criação de jogos na Unity nas horas vagas.
