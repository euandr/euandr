...
#         open=False, 
#         modal=True,
#         title=ft.Text("Bem vindo ao AndZap"),
...
def main(pagina):
    ...
    def entrar_popup(evento):
        ...
        # fechar o popup
        popup.open = False
        # limpar a tela e centralizar tudo
        pagina.controls.clear()
        pagina.add(
            ft.Container(
                content=ft.Column(
                    [
                        chat,  # Chat na parte superior
                        ft.Row(
                            [campo_mensagem, botao_enviar_mensagem],
                    ...
                    spacing=30,  # Espaçamento entre o chat e os campos de mensagem
                ),
                expand=True,
                alignment=ft.alignment.center,  # Centraliza o container inteiro na tela
            )
        )
        pagina.update()
    ...
    # Adicionando os componentes iniciais centralizados
    conteudo = ft.Column(
        controls=[
            texto,
            botao_iniciar,
    ...
    pagina.add(
        ft.Container(
            content=conteudo,
            expand=True,  # Faz com que ocupe toda a tela
